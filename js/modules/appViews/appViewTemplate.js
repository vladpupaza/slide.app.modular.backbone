...
var appViewTemplate ={
	...
	<div id="draggebel" style="top:<%= _y %>;left:<%= _x %>;">\
			...
			<textarea class="text" maxlength="" onkeyup="$(\'#content\').trigger(\'txtnbleft\')" onkeypress="$(\'#content\').trigger(\'txtnbleft\')" onblur="$(\'#content\').trigger(\'updateReady\')"    rows="4" cols="50"><%= _text %></textarea>\
			<div id="txtnb"></div>\
		</div>\
	</div>',
